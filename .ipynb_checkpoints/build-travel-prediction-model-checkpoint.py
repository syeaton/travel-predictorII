...
from common.modeling import *
  ...
  # Code purpose: Take an arbitrary list of features (identified in common/modeling.py)
  # and rebuild a predictive model for those features.
  # We are predicting likelihood to travel internationally
...
#train/test split.
X_train, X_test, y_train, y_test = train_test_split(xVars, yVar, random_state=404)

#run logistic regression
lr = LogisticRegression(C=0.5, penalty='l1', solver='saga')
