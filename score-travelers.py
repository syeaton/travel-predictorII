...
ska.log(f"Scoring accuracy: {model_accuracy} ROC_AUC: {model_auc}",
...
for index, row in metrics_reindex.iterrows():
    ska.report('Percent of People predicted to travel', y=100*row['pct_ones'], x=index, x_label='Model index', y_label='Percent Yes')